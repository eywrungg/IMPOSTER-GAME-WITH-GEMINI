          ...
          <div className="relative z-10 min-h-screen py-6 px-4 flex items-center justify-center">
            <div className="max-w-2xl w-full">
              ...
              <button
                ...
                className="w-full px-8 py-4 bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-black text-xl rounded-xl transition-all duration-300 hover:scale-105 shadow-2xl shadow-yellow-500/30"
              >
                Play Again 🔄
              </button>
            </div>
