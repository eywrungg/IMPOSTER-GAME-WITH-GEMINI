      ...
      <div className="relative z-10 min-h-screen py-3 md:py-6 px-3 md:px-6">
        ...
        <div className="max-w-xl lg:max-w-2xl mx-auto">
          ...
          <div className="glass-yellow rounded-xl md:rounded-2xl p-3 md:p-5 shadow-2xl mb-4 animate-fadeInUp animation-delay-300">
            <div className="space-y-2 md:space-y-2.5 max-h-[400px] md:max-h-[450px] overflow-y-auto custom-scrollbar pr-1">
              {playerNames.map((name, index) => (
                ...
                >
                  {/* Player Number Badge */}
                  <div className="shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-lg bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center">
